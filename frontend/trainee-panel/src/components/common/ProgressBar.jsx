...
export default function ProgressBar({ value, tone = "accent", trackClassName = "", label }) {
  ...
  return (
    <div className="w-full">
      ...
      <div className={`h-2 w-full overflow-hidden rounded-full bg-line-soft ${trackClassName}`}>
        <div
